...
.mt-field-label[data-v-893b8616] {
  display: flex;
  column-gap: 0.25rem;
  align-items: center;
...
.mt-field-label--is-required[data-v-893b8616]::after {
  content: "*";
  color: var(--color-text-brand-default);
}
.mt-field-label--has-linked-inheritance[data-v-893b8616] {
  color: var(--color-text-accent-default);
}
.mt-field-label--with-error[data-v-893b8616] {
...
.mt-text--weight-bold[data-v-01ce30d7] {
  font-weight: var(--font-weight-bold);
}
.mt-text--weight-semibold[data-v-01ce30d7] {
  font-weight: var(--font-weight-semibold);
}
.mt-text--weight-medium[data-v-01ce30d7] {
  font-weight: var(--font-weight-medium);
}
.mt-text--weight-regular[data-v-01ce30d7] {
  font-weight: var(--font-weight-regular);
}
.mt-text--size-2xs[data-v-01ce30d7] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-2xs);
  line-height: var(--font-line-height-2xs);
}
.mt-text--size-xs[data-v-01ce30d7] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
}
.mt-text--size-s[data-v-01ce30d7] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-s);
  line-height: var(--font-line-height-s);
}
.mt-text--size-m[data-v-01ce30d7] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-m);
  line-height: var(--font-line-height-m);
}
.mt-text--size-l[data-v-01ce30d7] {
  font-family: var(--font-family-body);
  font-size: var(--font-size-l);
  line-height: var(--font-line-height-l);
}
.mt-text--size-xl[data-v-01ce30d7] {
  font-family: var(--font-family-headings);
  font-size: var(--font-size-xl);
  line-height: var(--font-line-height-xl);
}
.mt-text--size-2xl[data-v-01ce30d7] {
  font-family: var(--font-family-headings);
  font-size: var(--font-size-2xl);
  line-height: var(--font-line-height-2xl);
}
.mt-text--size-3xl[data-v-01ce30d7] {
  font-family: var(--font-family-headings);
...
.mt-banner--future-remove-default-margin[data-v-0cd8eb75] {
  margin-block-end: 0;
}
.mt-banner__title[data-v-0cd8eb75] {
  margin-block-end: 0;
}
.mt-banner__body[data-v-0cd8eb75] {
...
.mt-banner__body--icon[data-v-0cd8eb75] {
  padding: 1.5rem 3.75rem;
}
.mt-banner__body--closable[data-v-0cd8eb75] {
  padding-right: var(--mt-banner-close-button-size);
}
.mt-banner__icon[data-v-0cd8eb75] {
  position: absolute;
  display: block;
  left: 1.625rem;
  top: 1.75rem;
...
.mt-banner__close[data-v-0cd8eb75] {
...
&[data-v-0cd8eb75] :is(.mt-banner__icon, .mt-banner__close) {
...
.mt-field__error[data-v-cc988284] {
  display: flex;
  align-items: center;
...
.mt-progress-bar[data-v-13132802] {
  display: grid;
  grid-template-areas:
    "label progress"
    "track track"
...
.mt-progress-bar__progress-label[data-v-13132802] {
  color: var(--color-text-secondary);
  grid-area: progress;
  justify-self: end;
}
.mt-progress-bar__track[data-v-13132802] {
...
.mt-progress-bar__fill[data-v-13132802] {
  border-radius: var(--border-radius-round);
  height: 100%;
  background: var(--color-interaction-primary-default);
}
.mt-progress-bar__fill--with-error[data-v-13132802] {
  background: var(--color-interaction-critical-default);
}

.mt-button[data-v-e982b12f] {
...
.mt-button__content[data-v-e982b12f] {
  display: grid;
  grid-auto-flow: column;
  align-items: center;
  column-gap: 0.5rem;
}
.mt-button__content--hidden[data-v-e982b12f] {
  visibility: hidden;
}
.mt-button--primary[data-v-e982b12f] {
  background: var(--color-interaction-primary-default);
  color: var(--color-text-static-default);
  border-color: var(--color-interaction-primary-default);
}
.mt-button--primary .mt-icon[data-v-e982b12f] {
  color: var(--color-icon-static-default);
}
.mt-button--primary[data-v-e982b12f]:hover,
.mt-button--primary[data-v-e982b12f]:focus-visible,
.mt-button--primary[data-v-e982b12f]:active {
...
.mt-button--primary[data-v-e982b12f]:disabled,
.mt-button--primary.mt-button--disabled[data-v-e982b12f] {
  background: var(--color-interaction-primary-disabled);
  border-color: var(--color-interaction-primary-disabled);
  cursor: not-allowed;
}
.mt-button--primary-ghost[data-v-e982b12f] {
  background: transparent;
  border: 1px solid var(--color-border-brand-selected);
  border-color: var(--color-border-brand-selected);
  color: var(--color-text-brand-default);
}
.mt-button--primary-ghost[data-v-e982b12f]:is(:hover, :focus-visible, :active) {
  background: var(--color-background-brand-default);
}
.mt-button--primary-ghost[data-v-e982b12f]:focus-visible {
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--primary-ghost[data-v-e982b12f]:disabled,
.mt-button--primary-ghost.mt-button--disabled[data-v-e982b12f] {
  color: var(--color-text-brand-disabled);
  border-color: var(--color-border-brand-disabled);
  background: transparent;
}
.mt-button--primary-ghost:disabled .mt-icon[data-v-e982b12f],
.mt-button--primary-ghost.mt-button--disabled .mt-icon[data-v-e982b12f] {
  color: var(--color-icon-brand-disabled);
}
.mt-button--primary-ghost .mt-icon[data-v-e982b12f] {
  color: var(--color-icon-brand-default);
}
.mt-button--secondary[data-v-e982b12f] {
  background: var(--color-interaction-secondary-default);
  border: 1px solid var(--color-border-primary-default);
  color: var(--color-text-primary-default);
}
.mt-button--secondary[data-v-e982b12f]:is(:hover, :focus-visible, :active) {
  background: var(--color-interaction-secondary-hover);
}
.mt-button--secondary[data-v-e982b12f]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--secondary[data-v-e982b12f]:disabled,
.mt-button--secondary.mt-button--disabled[data-v-e982b12f] {
  color: var(--color-text-primary-disabled);
  background: var(--color-interaction-secondary-disabled);
  cursor: not-allowed;
}
.mt-button--secondary:disabled .mt-icon[data-v-e982b12f],
.mt-button--secondary.mt-button--disabled .mt-icon[data-v-e982b12f] {
  color: var(--color-icon-primary-disabled);
}
.mt-button--secondary .mt-icon[data-v-e982b12f] {
  color: var(--color-icon-primary-default);
}
.mt-button--critical[data-v-e982b12f] {
  background: var(--color-interaction-critical-default);
  color: var(--color-text-static-default);
  border: 1px solid var(--color-interaction-critical-default);
}
.mt-button--critical[data-v-e982b12f]:is(:hover, :focus-visible, :active) {
  background: var(--color-interaction-critical-hover);
  border-color: var(--color-interaction-critical-hover);
}
.mt-button--critical[data-v-e982b12f]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
.mt-button--critical[data-v-e982b12f]:disabled,
.mt-button--critical.mt-button--disabled[data-v-e982b12f] {
  background: var(--color-interaction-critical-disabled);
  border-color: var(--color-interaction-critical-disabled);
}
.mt-button--critical:disabled .mt-icon[data-v-e982b12f],
.mt-button--critical.mt-button--disabled .mt-icon[data-v-e982b12f],
.mt-button--critical .mt-icon[data-v-e982b12f] {
  color: var(--color-icon-static-default);
}
.mt-button--critical-ghost[data-v-e982b12f] {
  background: transparent;
  border: 1px solid var(--color-border-critical-default);
  color: var(--color-text-critical-default);
}
.mt-button--critical-ghost[data-v-e982b12f]:is(:hover, :focus-visible, :active) {
  background-color: var(--color-background-critical-dark);
}
.mt-button--critical-ghost[data-v-e982b12f]:focus-visible {
  border-color: var(--color-border-brand-selected);
  box-shadow: 0 0 4px 0 rgba(255, 0, 0, 0.3);
}
.mt-button--critical-ghost[data-v-e982b12f]:disabled,
.mt-button--critical-ghost.mt-button--disabled[data-v-e982b12f] {
  color: var(--color-text-critical-disabled);
  border-color: var(--color-border-critical-disabled);
}
.mt-button--critical-ghost:disabled .mt-icon[data-v-e982b12f],
.mt-button--critical-ghost.mt-button--disabled .mt-icon[data-v-e982b12f] {
  color: var(--color-icon-critical-disabled);
}
.mt-button--critical-ghost .mt-icon[data-v-e982b12f] {
  color: var(--color-icon-critical-default);
}
.mt-button--action[data-v-e982b12f] {
  border: 1px solid #e2e8f0;
  background-color: #ffffff;
  color: #000000;
}
.mt-button--action .mt-icon[data-v-e982b12f] {
  color: #1a202c;
}
.mt-button--action[data-v-e982b12f]:hover {
  background-color: #edf2f7;
  color: #4a5568;
}
.mt-button--action[data-v-e982b12f]:disabled {
  background-color: #f7fafc;
  color: #a0aec0;
}
.mt-button--block[data-v-e982b12f] {
  display: block;
  width: 100%;
  display: flex;
  justify-content: center;
...
.mt-button--x-small[data-v-e982b12f] {
  padding-left: var(--scale-size-10);
  padding-right: var(--scale-size-10);
  font-size: var(--font-size-2xs);
  min-height: 24px;
}
.mt-button--x-small.mt-button--square[data-v-e982b12f] {
  width: var(--scale-size-24);
  height: var(--scale-size-24);
}
.mt-button--small[data-v-e982b12f] {
  padding-left: 15px;
  padding-right: 15px;
  font-size: var(--font-size-2xs);
  min-height: 32px;
}
.mt-button--small.mt-button--square[data-v-e982b12f] {
  width: var(--scale-size-32);
  height: var(--scale-size-32);
}
.mt-button--default[data-v-e982b12f] {
  padding-inline: 1rem;
  font-size: var(--font-size-xs);
  min-height: 2.5rem;
}
.mt-button--default.mt-button-square[data-v-e982b12f] {
  width: 2.5rem;
  height: 2.5rem;
}
.mt-button--large[data-v-e982b12f] {
  padding-left: 1.75rem;
  padding-right: 1.75rem;
  min-height: 3rem;
  font-size: var(--font-size-2xs);
}
.mt-button--large.mt-button--square[data-v-e982b12f] {
  width: var(--scale-size-48);
  height: var(--scale-size-48);
}
.mt-button--square[data-v-e982b12f] {
...
.mt-button--square .mt-button__content[data-v-e982b12f] {
  display: inline;
}
.mt-button__loader[data-v-e982b12f] {
  border-radius: var(--border-radius-xs);
}
...
.mt-field-copyable[data-v-a4207187] {
  cursor: pointer;
}
...
&[data-v-52a768d7]:focus-visible {
    outline-offset: 0.25rem;
    outline: 2px solid var(--color-border-brand-selected);
}
&[data-v-52a768d7]:where(:hover, :focus-visible) {
    color: var(--color-icon-brand-hover);
}
}
.mt-help-text[data-v-52a768d7]::after {
  content: "";
  display: block;
  position: absolute;
  inset: 0;
...
.mt-help-text__tooltip-text[data-v-52a768d7] {
  display: none;
}
/* ------------------------------------
 * Administration variables
...
&[data-v-7ede804f]:focus-visible {
    outline-offset: 2px;
    outline: 2px solid var(--color-border-brand-selected);
    border-radius: var(--border-radius-xs);
}
}
.mt-link[data-v-7ede804f]:is(:disabled, .mt-link--disabled) {
  cursor: not-allowed;
}
.mt-link--primary[data-v-7ede804f] {
  color: var(--color-text-brand-default);
}
.mt-link--primary[data-v-7ede804f]:is(:hover, :active) {
  color: var(--color-text-brand-hover);
}
.mt-link--primary[data-v-7ede804f]:is(:disabled, .mt-link--disabled) {
  color: var(--color-text-brand-disabled);
}
.mt-link--critical[data-v-7ede804f] {
  color: var(--color-text-critical-default);
}
.mt-link--critical[data-v-7ede804f]:is(:hover, :active) {
  color: var(--color-text-critical-hover);
}
.mt-link--critical[data-v-7ede804f]:is(:disabled, .mt-link--disabled) {
  color: var(--color-text-critical-disabled);
}
...
&[data-v-dd85aa54]:is(:hover, :focus-visible) {
      background-color: var(--color-interaction-secondary-hover);
}
&[data-v-dd85aa54]:disabled {
      cursor: default;
}
}
}
input.mt-number-field__align-end[data-v-dd85aa54] {
  text-align: end;
}
...
.mt-field--password {
& input[data-v-57aefe79] {
    padding-right: var(--scale-size-40);
}
& .mt-icon[data-v-57aefe79] {
    color: var(--color-icon-primary-default);
}
}
.mt-field--password--untoggable .mt-field__input input[data-v-57aefe79] {
...
&[data-v-57aefe79]:is(:hover, :focus-visible) {
    background-color: var(--color-interaction-secondary-hover);
}
}
.mt-field--password__container[data-v-57aefe79] {
  position: relative;
  width: 100%;
}
/* ------------------------------------
...
.mt-field--switch__container .mt-field--switch.mt-field--switch-no-margin-top {
  margin-top: 0;
}
.mt-field--switch__container .mt-field--switch.mt-field--switch-no-margin-bottom {
  margin-bottom: 0;
}
.mt-field--switch__container .mt-field--switch .mt-field__error {
  margin-top: -14px;
}
.mt-field--switch__container .mt-field--switch .mt-field {
  margin-bottom: 0;
}
.mt-field--switch__container .mt-field--switch .mt-field .mt-block-field__block {
  border: none;
}
.mt-field--switch__container .mt-field--switch .mt-field__label {
  margin-bottom: 0;
}
.mt-field--switch__container .mt-field--switch .mt-field__label label {
  cursor: pointer;
  flex-grow: initial;
  padding: 15px 0 15px var(--scale-size-4);
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__content {
  display: grid;
  grid-template-columns: 24px 1fr auto;
  align-items: center;
}
.mt-field--switch__container .mt-field--switch.mt-field--switch-bordered .mt-field__error {
  padding: 0 var(--scale-size-16);
}
.mt-field--switch__container .mt-field--switch.mt-field--switch-bordered .mt-field--switch__content {
  border-radius: 4px;
  border: 1px solid var(--color-border-primary-default);
  padding: 0 var(--scale-size-16);
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input {
  position: relative;
  padding: 15px 0;
  width: var(--scale-size-24);
  height: 100%;
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input input[type=checkbox] {
  opacity: 0;
  display: block;
  width: 100%;
  height: 100%;
...
.mt-field--switch__container .mt-field--switch .mt-field--switch__input input[type=checkbox]:disabled {
  cursor: auto;
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input input[type=checkbox]:disabled ~ .mt-field__switch-state {
  background: var(--color-interaction-secondary-disabled);
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input input[type=checkbox]:disabled ~ .mt-field__switch-state .mt-field__switch-state-knob {
  background: var(--color-icon-primary-disabled);
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input input[type=checkbox]:checked ~ .mt-field__switch-state {
  background: var(--color-interaction-primary-default);
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input input[type=checkbox]:checked ~ .mt-field__switch-state .mt-field__switch-state-knob {
  left: var(--scale-size-10);
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input input[type=checkbox]:checked:disabled ~ .mt-field__switch-state {
  background: var(--color-interaction-primary-disabled);
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input input[type=checkbox]:checked:disabled ~ .mt-field__switch-state .mt-field__switch-state-knob {
  background: var(--color-icon-static-default);
}
.mt-field--switch__container .mt-field--switch .mt-field--switch__input .mt-field__switch-state {
  position: absolute;
  width: 100%;
  height: var(--scale-size-16);
  z-index: 1;
...
.mt-field--switch__container .mt-field--switch .mt-field--switch__input .mt-field__switch-state .mt-field__switch-state-knob {
  transition: all 0.3s ease-in-out;
...
.mt-field--switch__container .mt-field--switch .mt-field__inheritance-icon {
  display: flex;
  align-items: center;
  margin-left: var(--scale-size-8);
  margin-right: 0;
}
.mt-field--switch__container .mt-field--switch.has--error.mt-field--switch-bordered .mt-field--switch__content {
  border: 1px solid var(--color-border-critical-default);
  background: var(--color-background-critical-dark);
}
.mt-field--switch__container .mt-field--switch.has--error .mt-field__switch-state {
  background: var(--color-interaction-critical-default);
}
.mt-field--switch__container .mt-field--switch.has--error input[type=checkbox]:checked ~ .mt-field__switch-state {
  background: var(--color-interaction-critical-default);
}
.mt-field--switch__container .mt-field--switch:has(:focus-visible) .mt-field__switch-state {
  outline: 2px solid var(--color-border-brand-selected);
  outline-offset: 2px;
}
.mt-field--switch__container .mt-field__error--move-up {
  transform: translateY(-15px);
  margin-bottom: 21px;
}/* ------------------------------------
 * Administration variables
...
.mt-field--textarea textarea {
  line-height: 22px;
  min-height: 125px;
  max-height: 300px;
  resize: vertical;
}
.mt-field--textarea.has--error textarea {
  background: var(--color-background-critical-dark);
}/* ------------------------------------
 * Administration variables
 * Table of contents
...
.mt-popover-item__switch .mt-field--switch {
  margin: 0;
}
.mt-popover-item__switch .mt-field--switch .mt-field--switch__input {
  height: var(--scale-size-16);
  padding: 0;
}
.mt-popover-item__switch .mt-field--switch .mt-field__label {
  display: none;
}
...
.mt-context-button.is--disabled .mt-context-button__button {
  color: var(--color-icon-primary-disabled);
  cursor: initial;
}
.mt-context-button.is--disabled .mt-context-button__button:hover {
  border: none;
}
.mt-context-button.is--disabled.is--open .mt-context-button__button {
  border: none;
}
.mt-context-button.is--open .mt-context-button__button {
  border-color: var(--color-border-primary-default);
}
.mt-context-button .mt-context-button__button {
  position: relative;
  color: var(--color-icon-primary-default);
  background: 0 none;
  border: 1px solid transparent;
...
.mt-context-button .mt-context-button__button:hover {
  border-color: var(--color-border-primary-default);
}
.mt-context-button.has--error .mt-context-button__button {
  color: #e86982;
}
.mt-context-button.has--error .mt-context-button__button .mt-icon {
  color: var(--color-icon-primary-default);
}
/**
...
&:not(:has(.mt-card__tabs:empty)) .mt-card__header[data-v-36576c2b] {
    border-bottom: none;
}
}
.mt-card--future-remove-default-margin[data-v-36576c2b] {
  margin-block-end: 0;
}
.mt-card__content {
&[data-v-36576c2b] {
...
&[data-v-36576c2b] > :where(h1, h2, h3, h4, h5, h6) {
    font-weight: normal;
}
& > h1[data-v-36576c2b] {
    font-size: 1.5rem;
...
&[data-v-36576c2b] > :where(h4, h5, h6) {
    font-size: 1.125rem;
}
...
&[data-v-36576c2b]:hover {
      color: var(--color-text-brand-hover);
}
}
}
.mt-card--has-footer {
& .mt-card__content[data-v-36576c2b] {
    border: none;
...
& .mt-card__title[data-v-36576c2b],
  & .mt-card__subtitle[data-v-36576c2b] {
    width: auto;
    position: relative;
    top: 0;
    left: 0;
...
.mt-card--future-ignore-max-width[data-v-36576c2b] {
  max-width: none;
  margin-inline: 0;
}
.mt-card__titles[data-v-36576c2b] {
  display: flex;
  flex-direction: column;
  justify-content: space-between;
}
...
& .mt-card__inheritance-toggle[data-v-36576c2b] {
    color: var(--color-icon-accent-default);
}
}
.mt-card--grid {
...
& .mt-grid[data-v-36576c2b] {
      border-top: none;
}
}
}
.mt-card__header[data-v-36576c2b] {
  display: flex;
  flex-wrap: wrap;
  align-items: stretch;
  gap: 0.75rem;
...
&[data-v-36576c2b]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    outline-offset: 2px;
    border-radius: var(--border-radius-button);
}
}
.mt-card__titles-right-slot[data-v-36576c2b] {
  color: var(--color-text-primary-default);
  margin-left: auto;
}
.mt-card__footer {
...
.mt-empty-state[data-v-732f6717] {
  display: flex;
  flex-direction: column;
  align-items: flex-start;
}
.mt-empty-state__icon[data-v-732f6717] {
  display: inline-block;
  padding: 0.75rem;
  border-radius: var(--border-radius-xs);
  background-color: var(--color-interaction-secondary-dark);
}
.mt-empty-state__headline[data-v-732f6717] {
  margin-top: 1.5rem;
  margin-bottom: 0;
}
.mt-empty-state__description[data-v-732f6717] {
  margin-top: 0.5rem;
}
.mt-empty-state__link[data-v-732f6717] {
  margin-top: 0.5rem;
}
.mt-empty-state__button[data-v-732f6717] {
  margin-top: 1.5rem;
}

.mt-tabs[data-v-b0e69830] {
  display: flex;
  position: relative;
  box-shadow: inset 0 -1px 0 var(--color-border-primary-default);
}
.mt-tabs--small[data-v-b0e69830] {
  max-width: 800px;
  margin: 0 auto 15px auto;
}
.mt-tabs--future-remove-default-margin[data-v-b0e69830] {
  margin-block-end: 0;
}
.mt-tabs--vertical {
&[data-v-b0e69830] {
...
& .mt-tabs__slider[data-v-b0e69830] {
    top: 0;
    bottom: auto;
    left: 3px;
}
...
&[data-v-b0e69830]:disabled {
    cursor: not-allowed;
    color: var(--color-text-primary-disabled);
}
&[data-v-b0e69830]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    outline-offset: 2px;
    border-radius: var(--border-radius-xs);
}
&[data-v-b0e69830]::after {
...
.mt-tabs__item--error[data-v-b0e69830] {
  color: var(--color-text-critical-default);
}
.mt-tabs__item--active[data-v-b0e69830] {
  font-weight: var(--font-weight-medium);
}
.mt-tabs__slider[data-v-b0e69830] {
...
.mt-tabs__slider--error[data-v-b0e69830] {
  background-color: var(--color-border-critical-default);
}
.mt-tabs__slider--animated[data-v-b0e69830] {
...
&[data-v-3a603592] :last-child {
    border-top-right-radius: var(--border-radius-xs);
    border-bottom-right-radius: var(--border-radius-xs);
}
&[data-v-3a603592] :first-child {
    border-top-left-radius: var(--border-radius-xs);
    border-bottom-left-radius: var(--border-radius-xs);
}
}
.mt-pagination__controls[data-v-3a603592] {
  display: inline-flex;
  border-radius: var(--border-radius-xs);
  border: 1px solid var(--color-border-primary-default);
}
.mt-pagination__info-text[data-v-3a603592] {
  color: var(--color-text-tertiary-default);
  font-size: var(--font-size-xs);
  line-height: var(--font-line-height-xs);
  font-family: var(--font-family-body);
...
&[data-v-3a603592]:focus-visible {
    outline: 1px solid var(--color-border-brand-selected);
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-3a603592]:hover:not(:disabled) {
    background-color: var(--color-interaction-secondary-hover);
}
&[data-v-3a603592]:last-of-type {
    border-right: none;
}
&[data-v-3a603592]:disabled {
...
&[data-v-3a603592]::-webkit-outer-spin-button,
  &[data-v-3a603592]::-webkit-inner-spin-button {
    -webkit-appearance: none;
    margin: 0;
}
&[type="number"][data-v-3a603592] {
    -moz-appearance: textfield;
}
}
...
&[data-v-8735df65]:focus-within {
    border-color: var(--color-border-brand-selected);
    box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
}
.mt-search--size-default[data-v-8735df65] {
  padding: 0.75rem 1rem;
}
.mt-search--size-small[data-v-8735df65] {
...
.mt-search--disabled[data-v-8735df65] {
  background-color: var(--color-background-primary-disabled);
}
/* ------------------------------------
 * Administration variables
...
&[data-v-c76c4453]:not(:last-child) {
    margin-bottom: 2rem;
}
}
.mt-skeleton-bar__shimmer[data-v-c76c4453] {
  height: 100%;
  ...
  animation: barShimmer-c76c4453 1.8s infinite;
  animation-timing-function: linear;
  transform: translate(-100%);
}
@keyframes barShimmer-c76c4453 {
to {
 ...
 * 8. z-index
 * ------------------------------------ */
@keyframes ellipsis-e39d618c {
to {
    width: 1.25rem;
}
}
.mt-data-table-text-renderer-cell[data-v-e39d618c] {
  display: flex;
  align-items: center;
}
.mt-data-table-text-renderer-cell .mt-data-table-preview-image-renderer[data-v-e39d618c] {
  position: relative;
  width: 34px;
  height: var(--scale-size-24);
  border: 1px solid var(--color-border-primary-default);
...
.mt-data-table-text-renderer-cell .mt-data-table-preview-image-renderer img.mt-data-table-preview-image-renderer-item[data-v-e39d618c] {
  position: absolute;
  left: 50%;
  top: 50%;
  transform: translate(-50%, -50%);
...
.mt-data-table-text-renderer-cell a.mt-data-table-text-renderer[data-v-e39d618c] {
  font-weight: var(--font-weight-medium);
  text-decoration: none;
  color: var(--color-text-primary-default);
}
.mt-data-table-text-renderer-cell a.mt-data-table-text-renderer[data-v-e39d618c]:hover {
  text-decoration: underline;
  color: var(--color-text-brand-default);
}
...
&:hover {
.mt-toast-notification__timer-loader[data-v-eca0bfdc] {
      animation-play-state: paused;
}
}
&[data-v-eca0bfdc]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
...
&.mt-icon > svg[data-v-eca0bfdc] {
    fill: black;
    width: var(--scale-size-20) !important;
    height: var(--scale-size-20) !important;
}
}
.mt-toast-notification__content-left[data-v-eca0bfdc] {
  display: flex;
  flex: 1;
...
.mt-toast-notification__content-right[data-v-eca0bfdc] {
  display: flex;
  justify-content: flex-end;
  margin-right: var(--scale-size-16);
  align-items: center;
}
.mt-toast-notification__timer[data-v-eca0bfdc] {
  height: 3px;
  width: 100%;
...
.mt-toast-notification__timer-loader[data-v-eca0bfdc] {
  ...
  animation: shrink-eca0bfdc 10s forwards linear 0.5s;
}
@keyframes shrink-eca0bfdc {
from {
    transform: scaleX(1);
}
to {
...
.mt-toast-notification__message[data-v-eca0bfdc] {
  max-width: 200px;
  text-overflow: ellipsis;
  overflow: hidden;
  white-space: nowrap;
}
.mt-toast-notification__message-space[data-v-eca0bfdc] {
  padding-left: var(--scale-size-8);
}
.mt-toast-notification__content {
&[data-v-eca0bfdc] {
...
& .mt-toast-notification__close-action[data-v-eca0bfdc] {
 ...
 * 8. z-index
 * ------------------------------------ */
@keyframes ellipsis-20c87f8d {
to {
    width: 1.25rem;
}
}
.mt-toast[data-v-20c87f8d] {
  display: flex;
  position: fixed;
  justify-content: center;
  bottom: 0;
...
.mt-toast--bottom-left[data-v-20c87f8d] {
  flex: 1;
}
.mt-toast--bottom-center[data-v-20c87f8d] {
  flex: 1;
  display: flex;
  justify-content: center;
}
.mt-toast--bottom-center .mt-toast-notification[data-v-20c87f8d] {
  display: flex;
  z-index: 1600;
  position: absolute;
  height: 51px;
...
.mt-toast--bottom-center .quick-toasts-enter-active[data-v-20c87f8d],
.mt-toast--bottom-center .quick-toasts-leave-active[data-v-20c87f8d] {
  transition: opacity 0.5s ease;
}
.mt-toast--bottom-center .quick-toasts-enter-from[data-v-20c87f8d],
.mt-toast--bottom-center .quick-toasts-leave-to[data-v-20c87f8d] {
  opacity: 0;
}
.mt-toast--bottom-center .quick-toasts-enter-active[data-v-20c87f8d] {
  transition-delay: 0.5s;
}
.mt-toast--bottom-right[data-v-20c87f8d] {
  flex: 1;
  display: flex;
  justify-content: flex-end;
  padding-right: 1rem;
}
.mt-toast--bottom-right .mt-toast-notification[data-v-20c87f8d] {
  display: flex;
...
.mt-toast--bottom-right .toasts-enter-from[data-v-20c87f8d] {
  transform: translateY(50px) !important;
  opacity: 0;
  z-index: 0;
}
.mt-toast--bottom-right .toasts-leave-to[data-v-20c87f8d] {
  transform: scale(0.9, 0.4) !important;
  transform-origin: top;
  opacity: 0;
  z-index: 0;
}
.mt-toast--bottom-right .toasts-enter-active[data-v-20c87f8d],
.mt-toast--bottom-right .toasts-leave-active[data-v-20c87f8d] {
  transition: all 0.7s ease;
}
.mt-toast--expanded .mt-toast--bottom-right .mt-toast-notification[data-v-20c87f8d]:nth-child(n+2) {
  transform: translateY(calc(var(--num) * -68px));
}
.mt-toast--collapsed .mt-toast--bottom-right .mt-toast-notification[data-v-20c87f8d]:nth-child(1) {
  z-index: 1599;
}
.mt-toast--collapsed .mt-toast--bottom-right .mt-toast-notification[data-v-20c87f8d]:nth-child(2) {
...
.mt-toast--collapsed .mt-toast--bottom-right .mt-toast-notification[data-v-20c87f8d]:nth-child(3) {
...
.mt-toast--collapsed .mt-toast--bottom-right .mt-toast-notification[data-v-20c87f8d]:nth-child(n+4) {
...
.mt-modal--width-s[data-v-6ea188e0] {
  --mt-modal-width: 27.5rem;
}
.mt-modal--width-m[data-v-6ea188e0] {
  --mt-modal-width: 45rem;
}
.mt-modal--width-l[data-v-6ea188e0] {
  --mt-modal-width: 64rem;
}
.mt-modal--width-xl[data-v-6ea188e0] {
  --mt-modal-width: 90rem;
}
.mt-modal--width-full[data-v-6ea188e0] {
  --mt-modal-width: 100%;
}
.modal-enter-active[data-v-6ea188e0] {
...
.modal-leave-active[data-v-6ea188e0] {
...
.modal-enter-from[data-v-6ea188e0],
.modal-leave-to[data-v-6ea188e0] {
  opacity: 0;
@media (prefers-reduced-motion: no-preference) {
    scale: 0.9;
}
}
.mt-modal__title[data-v-6ea188e0] {
  margin-block-end: 0;
}
.mt-modal__content[data-v-6ea188e0] {
  position: relative;
  overflow-y: auto;
}
.mt-modal__content-inner[data-v-6ea188e0] {
  padding: var(--scale-size-24);
}
.mt-modal__content-inner--no-padding[data-v-6ea188e0] {
  padding: 0;
}
.mt-modal__scroll-shadow[data-v-6ea188e0] {
  position: sticky;
  left: 0;
  right: 0;
  height: var(--scale-size-4);
...
.mt-modal__scroll-shadow--top[data-v-6ea188e0] {
  top: 0;
}
.mt-modal__scroll-shadow--bottom[data-v-6ea188e0] {
  bottom: 0;
}
.shadow-fade-enter-active[data-v-6ea188e0] {
  transition: opacity 400ms cubic-bezier(0.05, 0.7, 0.1, 1);
@media (prefers-reduced-motion: no-preference) {
    transition: opacity 400ms cubic-bezier(0.05, 0.7, 0.1, 1);
}
}
.shadow-fade-leave-active[data-v-6ea188e0] {
  transition: opacity 200ms cubic-bezier(0.3, 0, 0.8, 0.15);
@media (prefers-reduced-motion: no-preference) {
    transition: opacity 200ms cubic-bezier(0.3, 0, 0.8, 0.15);
}
}
.shadow-fade-enter-from[data-v-6ea188e0],
.shadow-fade-leave-to[data-v-6ea188e0] {
  opacity: 0;
@media (prefers-reduced-motion: no-preference) {
    scale: 0.9;
}
}
.mt-modal__footer[data-v-6ea188e0] {
  padding: var(--scale-size-24);
  border-top: 1px solid var(--color-border-primary-default);
}
.mt-modal__header[data-v-6ea188e0] {
  padding: var(--scale-size-24);
  border-bottom: 1px solid var(--color-border-primary-default);
  display: flex;
  justify-content: space-between;
...
.mt-modal__header-content[data-v-6ea188e0] {
  display: flex;
  flex-direction: row;
  align-items: baseline;
...
@media (hover: hover) {
&[data-v-6ea188e0]:hover {
      background-color: var(--color-interaction-secondary-hover);
}
}
&[data-v-6ea188e0]:focus-visible {
    outline: 2px solid var(--color-border-brand-selected);
    box-shadow: 0 0 4px 0 rgba(24, 158, 255, 0.3);
}
}
...
.v-enter-active[data-v-ff1c3ce6],
.v-leave-active[data-v-ff1c3ce6] {
...
.v-enter-from[data-v-ff1c3ce6],
.v-leave-to[data-v-ff1c3ce6] {
  opacity: 0;
}
.v-enter-from[data-placement="top"][data-v-ff1c3ce6],
.v-leave-to[data-placement="top"][data-v-ff1c3ce6] {
  margin-bottom: 0.25rem;
}
.v-enter-from[data-placement="bottom"][data-v-ff1c3ce6],
.v-leave-to[data-placement="bottom"][data-v-ff1c3ce6] {
  margin-top: 0.25rem;
}
.v-enter-from[data-placement="left"][data-v-ff1c3ce6],
.v-leave-to[data-placement="left"][data-v-ff1c3ce6] {
  margin-right: 0.25rem;
}
.v-enter-from[data-placement="right"][data-v-ff1c3ce6],
.v-leave-to[data-placement="right"][data-v-ff1c3ce6] {
  margin-left: 0.25rem;
}
...
.mt-text-editor__table-modal-footer[data-v-e31a079b] {
  display: flex;
  justify-content: flex-end;
  gap: var(--scale-size-8);
}

.mt-text-editor[data-v-5dc464fb] {
  display: flex;
  flex-direction: column;
  background-color: var(--color-elevation-surface-default);
}
label[data-v-5dc464fb] {
  display: block;
  font-size: var(--font-size-xs);
  line-height: 1rem;
  color: var(--color-text-primary-default);
...
.mt-text-editor__box[data-v-5dc464fb] {
  border: 1px solid var(--color-border-primary-default);
  border-radius: var(--border-radius-xs);
}
.mt-text-editor__content[data-v-5dc464fb],
.mt-text-editor__code-editor[data-v-5dc464fb] {
  height: 260px;
  overflow: auto;
}
.mt-text-editor__code-editor[data-v-5dc464fb] .cm-editor {
  height: inherit;
}
[data-v-5dc464fb] .mt-text-editor__content-editor {
  width: 100%;
  height: 100%;
  padding: var(--scale-size-16);
...
.mt-text-editor__footer[data-v-5dc464fb] {
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 0 var(--scale-size-16);
...
.mt-text-editor__footer-left[data-v-5dc464fb] {
  display: flex;
  align-items: center;
}
...
.mt-text-editor--inline-edit:focus-within .mt-text-editor__footer[data-v-5dc464fb] {
  pointer-events: all;
  transform: scale(1, 1);
}
.mt-text-editor--disabled .mt-text-editor__content[data-v-5dc464fb] {
  background-color: var(--color-background-primary-disabled);
}
[data-v-5dc464fb] .mt-text-editor__content-editor p.is-editor-empty:first-child::before {
  color: var(--color-text-secondary-default);
...
.mt-text-editor--error .mt-text-editor__box[data-v-5dc464fb] {
  border-color: var(--color-icon-critical-default);
}
.mt-text-editor--error .mt-text-editor__content[data-v-5dc464fb] {
  background-color: var(--color-background-critical-dark);
}
.mt-text-editor--error label[data-v-5dc464fb] {
  color: var(--color-text-critical-default);
}
/* ------------------------------------
 * Administration variables
